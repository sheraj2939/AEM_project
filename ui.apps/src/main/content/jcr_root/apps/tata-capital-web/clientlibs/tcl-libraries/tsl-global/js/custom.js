$(document).ready(function () {
  ...
  // $('.jsSelectValue .list').on('click', function () {
  //   var selectedVal = $(this)[0].innerText;
  //   $(this).parents('.custom-dropdown-wrap').find('.custom-dropdown-btn').html(selectedVal);
  //   $('.custom-dropdown-wrap .custom-dropdown-btn').removeClass('active');
  //   $('.custom-dropdown-wrap .custom-dropdown-block').removeClass('show');
  //   $('.jsSelectValue .list').removeClass('actives')
  //   $(this).addClass('actives');
  // })
  ...
  //   })
  // })
  $('.js-mobsubmenu .js-accord-col-mob .submenu-head-arrow').each(function () {
    $(this).click(function () {
...
/*10-2-2023 looking offer animation*/
  ...
  /*InstantPerSlider*/ 
  if ($(window).width() > 991) {
    if ($('.jsScoreSlider').hasClass('slick-initialized')) {
      $('.jsScoreSlider').slick('unslick');
    }
  } else {
    $('.jsScoreSlider').not('.slick-initialized').slick({
      dots: true,
      infinite: false,
      speed: 300,
      slidesToShow: 1,
...
// })
  ...
  /*$('.state-map').click(function (e) {
      if (($(window).width() < 1199) && ($(window).width() > 767)) {
          ...
          if ((id == "IN-MH") || (id == "IN-GJ") || (id == "IN-TN") || (id == "IN-KA") || (id == "IN-MP") || (id == "IN-OD") || (id == "IN-PB") || (id == "IN-TS") || (id == "IN-WB") || (id == "IN-JH") || (id == "IN-DL")) {
              descr_syle();
          }
