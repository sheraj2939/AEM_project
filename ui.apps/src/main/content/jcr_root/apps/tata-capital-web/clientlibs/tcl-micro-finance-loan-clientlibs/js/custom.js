...
// Advantage Of MFL
function AdvantageOfMFL() {
  apiCall("GET","/content/experience-fragments/tata-capital-web/en/component-ef/micro-finance-loan/advantage-of-mfl/advantage-of-mfl.html").then(function (response) {
    operation(response,"AdvantageOfMFLEF",".key-features","/etc.clientlibs/tata-capital-web/clientlibs/tcl-micro-finance-loan-ef-clientlibs.css");
    cssLink("/etc.clientlibs/tata-capital-web/components/tcl-web-components/key-features/key-features-clientlib.css");
    jsScript("/etc.clientlibs/tata-capital-web/clientlibs/tcl-micro-finance-loan-ef-clientlibs.min.js");
  });
}

// Type of MFL
function typeOfMfl() {
  apiCall("GET","/content/experience-fragments/tata-capital-web/en/component-ef/micro-finance-loan/type-of-mfl/type-of-mfl.html").then(function (response) {
    operation(response,"typeOfMflEF",".who-can-take-loan","/etc.clientlibs/tata-capital-web/components/tcl-web-components/who-can-take-loan/who-can-take-loan-clientlib.css");
...
function MflLoanEligi() {
  apiCall("GET","/content/experience-fragments/tata-capital-web/en/component-ef/micro-finance-loan/mfl-eligibility-loan/mfl-eligibility-loan.html").then(function (response) {
    operation(response,"MflLoanEligiEF",".check-loan-eligibility","/etc.clientlibs/tata-capital-web/components/tcl-web-components/check-loan-eligibility/check-loan-eligibility-clientlib.min.css");
  });
}


// Why you should choose us
function SixReasonWhy() {
  apiCall("GET","/content/experience-fragments/tata-capital-web/en/component-ef/micro-finance-loan/six-reason-why/six-reason-why.html").then(function (response) {
    operation(response,"SixReasonWhyEF",".why-to-choose-us","/etc.clientlibs/tata-capital-web/components/tcl-web-components/why-to-choose-us/why-to-choose-us-clientlib.min.css");
  });
}
