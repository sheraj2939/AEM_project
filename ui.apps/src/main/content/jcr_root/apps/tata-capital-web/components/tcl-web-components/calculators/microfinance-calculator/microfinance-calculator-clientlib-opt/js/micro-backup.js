...
var roiValue;
var productVlaue = {
    'pragati': { 'min': 5000, 'max': 100000, 'from': 10000, 'roi': 25.49 },
    'vyapar': { 'min': 25000, 'max': 100000, 'from': 35000, 'roi': 26 },
...
function setMicofinanceCalcValues(result, calcName) {
    ...
    result = customRound(result.result);

    var emiAmount = document.querySelector('[data-calc-name=' + calcName + '] .emi-amount');
    emiAmount.innerText = '₹' + result.toLocaleString("EN-IN") + '*';
};
$(document).ready(function () {
    try {
        ...
        $('[data-list] li a').click(function () {
            $("[data-tenure='24']").removeClass('d-none');
            $("[data-tenure='36']").removeClass('d-none');
            ...
            if (microProduct.toLowerCase() != "tatkal") {
                ...
                $("[data-tenure='24']").addClass('d-none');
                $("[data-tenure='36']").addClass('d-none');
                $('.month-tenure').prepend('<li class="microfinance-checkbox-button button tenure tatkalNum d-none"></li>');
                $('.tatkalNum').remove();
                var element = '<li class="microfinance-checkbox-button button tenure tatkalNum"><div class="checkbox-btn-wrap"><input type="radio" name="tenure" value="6" data-input="microfinance"><a type="button" class="btn-checkbox">6</a></div></li>' +
                    '<li class="microfinance-checkbox-button button tenure tatkalNum"><div class="checkbox-btn-wrap"><input type="radio" name="tenure" value="9" data-input="microfinance"><a type="button" class="btn-checkbox">9</a></div></li>'
